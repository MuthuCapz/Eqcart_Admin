...
class ViewOwnShopPage extends StatefulWidget {
  @override
  _ViewOwnShopPageState createState() => _ViewOwnShopPageState();
}

class _ViewOwnShopPageState extends State<ViewOwnShopPage> {
  List<DocumentSnapshot> cachedShops = []; // Cache last fetched data

  @override
  Widget build(BuildContext context) {
    return StreamProvider<List<DocumentSnapshot>>.value(
      value: FirebaseFirestore.instance.collection('own_shops').snapshots().map(
        (snapshot) {
...
class ShopListView extends StatelessWidget {
  ...
  void deleteShop(String shopId) {
    FirebaseFirestore.instance.collection('own_shops').doc(shopId).delete();
  }
}
